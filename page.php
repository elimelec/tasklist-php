...
function page_item_group($group) {
	...
	<div class="list-item flex">
		...
		<a href="tasks.php?list_id=<?=$group['id']?>">
			<button >Show</button>
		</a>
		<a href="edit_list.php?list_id=<?=$group['id']?>">
			<button>Edit</button>
		</a>
		<a href="delete_list.php?list_id=<?=$group['id']?>">
...
function page_item_task($task) {
	...
	<div class="list-item flex">
		...
		<a href="edit_task.php?task_id=<?=$task['id']?>">
			<button>Edit</button>
		</a>
		<a href="delete_task.php?task_id=<?=$task['id']?>">
			<button>Delete</button>
		</a>
	</div>
<?php
